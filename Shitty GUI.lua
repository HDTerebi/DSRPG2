...
local UpdateLogCategory = FinityWindow:Category("Update Log")
...
local UpdateLogSettings = UpdateLogCategory:Sector("Update Logs")
local UpdateLogSettings2 = UpdateLogCategory:Sector("Update Logs")
local UpdateLogSettings3 = UpdateLogCategory:Sector("Update Logs")
...
UpdateLogSettings:Cheat("Label", "Updated 8/2/2020 @ 3:55PM")
UpdateLogSettings:Cheat("Label", "Included Auto Noclip & Improved TP")
UpdateLogSettings2:Cheat("Label", "Updated 8/3/2020 @ 9:06AM")
UpdateLogSettings2:Cheat("Label", "Added Spoof Clicking")
UpdateLogSettings2:Cheat("Label", "It Simply Just Clicks The Thing/Item Without")
UpdateLogSettings2:Cheat("Label", "Teleporting You 2 It")
UpdateLogSettings3:Cheat("Label", "Updated 8/3/2020 @ 3:41AM")
UpdateLogSettings3:Cheat("Label", "Fixed Script Trying 2 Load In Twice.")
UpdateLogSettings4:Cheat("Label", "Updated 8/5/2020 @ 7:07PM")
UpdateLogSettings4:Cheat("Label", "God Mode, No Attack CD & Inf Block")
UpdateLogSettings5:Cheat("Label", "Updated 8/6/2020 @ 3:44AM")
